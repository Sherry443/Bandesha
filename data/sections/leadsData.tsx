...
export const leadsData: SectionProps = {
    ...
    heading: "Supercharge Your Business with High-Quality Leads",
    text: "Struggling to find the right customers for your business? At Jagha Global, we specialize in generating high-quality, conversion-ready leads for businesses across industries. ",
    button: {
        label: "More About Us",
        href: "/about-us",
        type: "primary"
