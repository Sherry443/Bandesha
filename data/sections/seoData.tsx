...
import WhyChooseUsImage from "@/public/img/why-choose-us/SEO.png";
...
export const SeoData: SectionProps = {
    ...
    heading: "Elevate rankings with our best SEO",
    text: "We ensure higher search rankings with expert SEO services, including On-Page and Off-Page optimization.",
    button: {
        label: "More About Us",
        href: "/about-us",
        type: "primary"
